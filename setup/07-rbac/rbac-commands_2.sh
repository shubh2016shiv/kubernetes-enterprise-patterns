#!/usr/bin/env bash
# =============================================================================
# FILE:    rbac-commands.sh
# PURPOSE: Backward-compatible wrapper for the RBAC walkthrough.
# USAGE:   bash setup/07-rbac/rbac-commands.sh
# WHEN:    Use this if older notes still reference rbac-commands.sh.
# PREREQS: Same as commands.sh: required namespaces exist and kubectl points at

#!/usr/bin/env bash
# =============================================================================
# FILE:    enterprise-commands.sh
# PURPOSE: Backward-compatible wrapper for the Enterprise Patterns walkthrough.
# USAGE:   bash setup/10-enterprise-patterns/enterprise-commands.sh
# WHEN:    Use this if older notes still reference enterprise-commands.sh.
